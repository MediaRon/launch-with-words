				...
				<div id="lww-home-options">
					...
					<div class="lww-admin-container lww-admin-box">
						...
						<ul>
							...
							<li><?php esc_html_e( 'Content Packs:', 'launch-with-words' ); ?> <a href="https://bridgetwillard.com/downloads/launch-with-words-starter-content-pack/" target="_blank"><?php esc_html_e( 'Download a free starter pack.', 'launch-with-words' ); ?></li>
						</ul>
					</div>
				</div>
				<?php
